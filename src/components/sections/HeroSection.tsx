...
const FloatingIcon = ({ icon: Icon, label, className }: { icon: any, label: string, className: string }) => (
  <div className={`absolute ${className} float hidden lg:block`}>
  ...
  return (
    <section className="hero-section relative">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="pt-40 pb-20 lg:pt-44 lg:pb-32">
          {/* Badge */}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            <Button 
              size="lg" 
              className="text-lg px-8 py-4 bg-gradient-to-r from-primary to-secondary text-white shadow-soft hover:shadow-glow hover:opacity-90 interactive-hover"
            >
              View Tools
            </Button>
            <Button 
              variant="ghost" 
              size="lg" 
              className="flex items-center space-x-2 px-8 py-4 text-lg glass hover:bg-white/20 dark:hover:bg-black/20"
            >
